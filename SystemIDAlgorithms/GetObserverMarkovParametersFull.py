...
def getObserverMarkovParametersFull(input_signal, output_signal):
    ...
    # Build matrix U
    U = np.zeros([(input_dimension + output_dimension) * (number_steps - 1) + input_dimension, number_steps])
    ...
    return observer_markov_parameters, U
